...
func (app *AppResourceManager) CreateVolumeResource(ctx context.Context, volumes ...model.VolumeSpec) ([]unstructured.Unstructured, error) {
...
func (app *AppResourceManager) CreateSnapshotResource(ctx context.Context, req *model.SnapshotRequest) ([]unstructured.Unstructured, error) {
...
func (app *AppResourceManager) CreateSnapshotScheduleResource(ctx context.Context, req *model.SnapshotScheduleRequest) ([]unstructured.Unstructured, error) {
